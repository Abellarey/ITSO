        ...
        const teamMembers = {
            ...
            6: {
                ...
                tech: ["Accounting Software", "Digital Payment Platforms"],
                photo: "./img/jen.png"
            },
            7: {
                name: "Joven Quinal",
                ...
                tech: ["Microsoft Excel", "Audit Checklist"],
                photo: "./img/joven.png"
            },
            8: {
            ...
            9: {
                ...
                tech: ["Mentoring", "Academic Guidance"],
            ...
            11: {
                ...
                tech: ["Communication Tools", "Case Management"],
                photo: "./img/carlo.png"
            },
            12: {
                name: "Kenji Generoso",
            ...
            13: {
                ...
                tech: ["Incident Report Forms", "CCTV / Event Monitoring Tools"],
                photo: "./img/carl.png"
            },
            14: {
                name: "Samuel Alcazar",
            ...
            16: {
                ...
                tech: ["Meta Business Suite", "Adobe Creative Suite"],
            ...
            18: {
                ...
                tech: ["Research Methodology", "Emerging Technologies"],
                photo: "./img/18.png"
            },
            19: {
            ...
            20: {
                ...
                tech: ["Networking", "Event Coordination"],
                photo: "./img/19.png"
            },
            21: {
            ...
            22: {
                ...
                tech: ["Documentation Tools", "Knowledge Management"],
            ...
            24: {
                ...
                tech: [" Camera", "Adobe Lightroom", "Adobe Photoshop"],
                photo: "./img/23.png"
            },
            25: {
        ...
        class Particle {
            constructor() {
                ...
                this.color = `rgba(${Math.floor(Math.random() * 100 + 155)}, ${Math.floor(Math.random() * 100 + 155)}, 255, 0.5)`;
            }
        ...
        document.querySelectorAll('.section, .event-card, .about-content').forEach(el => {
            observer.observe(el);
        });
        ...
        // Add hover effect to team images
